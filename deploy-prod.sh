...
oc create deploymentconfig api-pastry-fuse-impl --image=docker-registry.default.svc:5000/api-pastry-dev/api-pastry-impl:promoteToProd -n api-pastry-prod
...
oc set env dc/api-pastry-fuse-impl SPRING_APPLICATION_JSON="{\"server\":{\"undertow\":{\"io-threads\":1, \"worker-threads\":2 }}}" PRODUCT_WS_URL=https://microcks.app.itix.fr/soap/ProductService/1.0.0 KAFKA_BROKER_URL=my-cluster-kafka-bootstrap.amq-streams.svc.cluster.local:9092 -n api-pastry-prod
